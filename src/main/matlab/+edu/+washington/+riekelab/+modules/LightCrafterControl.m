classdef LightCrafterControl < symphonyui.ui.Module
    ...
    methods
        ...
        function createUi(obj, figureHandle)
            ...
            obj.centerOffsetFields.x = uicontrol( ...
                ...
                'Style', 'edit', ...
                'HorizontalAlignment', 'left', ...
                'Callback', @obj.onSetCenterOffsetX);
            Label( ...
                'Parent', offsetLayout, ...
                'String', 'X');
            obj.centerOffsetFields.y = uicontrol( ...
                ...
                'Style', 'edit', ...
                'HorizontalAlignment', 'left', ...
                'Callback', @obj.onSetCenterOffsetY);
            Label( ...
                'Parent', offsetLayout, ...
                'String', 'Y');
            set(offsetLayout, ...
    ...
    methods (Access = private)
        ...
        function onSetCenterOffsetX(obj, ~, ~)
            disp('X');
        end
        
        function onSetCenterOffsetY(obj, ~, ~)
            disp('Y');
        end
