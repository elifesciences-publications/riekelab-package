classdef SharedTwoPhotonWithMicrodisplay < edu.washington.riekelab.rigs.SharedTwoPhoton
    ...
    methods
        ...
        function obj = SharedTwoPhotonWithMicrodisplay()
            ...
            ramps('low')     = 65535 * importdata(riekelab.Package.getCalibrationResource('rigs', 'shared_two_photon', 'microdisplay_low_gamma_ramp.txt'));
            ramps('medium')  = 65535 * importdata(riekelab.Package.getCalibrationResource('rigs', 'shared_two_photon', 'microdisplay_medium_gamma_ramp.txt'));
            ramps('high')    = 65535 * importdata(riekelab.Package.getCalibrationResource('rigs', 'shared_two_photon', 'microdisplay_high_gamma_ramp.txt'));
