classdef TwoPhotonWithMicrodisplay < edu.washington.riekelab.rigs.TwoPhoton
    ...
    methods
        ...
        function obj = TwoPhotonWithMicrodisplay()
            ...
            ramps('low')     = 65535 * importdata(riekelab.Package.getCalibrationResource('rigs', 'two_photon', 'microdisplay_low_gamma_ramp.txt'));
            ramps('medium')  = 65535 * importdata(riekelab.Package.getCalibrationResource('rigs', 'two_photon', 'microdisplay_medium_gamma_ramp.txt'));
            ramps('high')    = 65535 * importdata(riekelab.Package.getCalibrationResource('rigs', 'two_photon', 'microdisplay_high_gamma_ramp.txt'));
