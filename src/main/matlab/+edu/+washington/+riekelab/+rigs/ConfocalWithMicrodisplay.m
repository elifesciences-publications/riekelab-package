classdef ConfocalWithMicrodisplay < edu.washington.riekelab.rigs.Confocal
    ...
    methods
        ...
        function obj = ConfocalWithMicrodisplay()
            ...
            ramps('low')     = 65535 * importdata(riekelab.Package.getResource('calibration', 'confocal', 'microdisplay_low_gamma_ramp.txt'));
            ramps('medium')  = 65535 * importdata(riekelab.Package.getResource('calibration', 'confocal', 'microdisplay_medium_gamma_ramp.txt'));
            ramps('high')    = 65535 * importdata(riekelab.Package.getResource('calibration', 'confocal', 'microdisplay_high_gamma_ramp.txt'));
