    ...
    methods
        ...
        function createUi(obj, figureHandle)
            ...
            lightBox = uix.BoxPanel( ...
                ...
                'TitleColor', [223/255 233/255 245/255], ...
                'BorderType', 'none', ...
                'FontName', get(figureHandle, 'DefaultUicontrolFontName'), ...
                'FontSize', get(figureHandle, 'DefaultUicontrolFontSize'));
            lightBoxLayout = uix.VBox( ...
                'Parent', lightBox);
            seperator = javacomponent(javax.swing.JSeparator(), [], lightBoxLayout);
            seperator.setForeground(java.awt.Color(186/255, 201/255, 219/255));
            lightLayout = uix.Grid( ...
                'Parent', lightBoxLayout, ...
                'Padding', 11, ...
                'Spacing', 7);
            Label( ...
                'Parent', lightLayout, ...
            ...
            seperator = javacomponent(javax.swing.JSeparator(), [], lightBoxLayout);
            seperator.setForeground(java.awt.Color(186/255, 201/255, 219/255));
            set(lightBoxLayout, 'Heights', [1 -1 1]);
            ...
            targetBox = uix.BoxPanel( ...
                ...
                'FontName', get(figureHandle, 'DefaultUicontrolFontName'), ...
                'FontSize', get(figureHandle, 'DefaultUicontrolFontSize'));
            targetBoxLayout = uix.VBox( ...
                'Parent', targetBox);
            seperator = javacomponent(javax.swing.JSeparator(), [], targetBoxLayout);
            seperator.setForeground(java.awt.Color(186/255, 201/255, 219/255));
            targetLayout = uix.Grid( ...
                'Parent', targetBoxLayout, ...
                'Padding', 11, ...
                'Spacing', 7);
            Label( ...
                'Parent', targetLayout, ...
            ...
            seperator = javacomponent(javax.swing.JSeparator(), [], targetBoxLayout);
            seperator.setForeground(java.awt.Color(186/255, 201/255, 219/255));
            set(targetBoxLayout, 'Heights', [1 -1 1]);
            ...
            converterBox = uix.BoxPanel( ...
                ...
                'FontName', get(figureHandle, 'DefaultUicontrolFontName'), ...
                'FontSize', get(figureHandle, 'DefaultUicontrolFontSize'));
            converterBoxLayout = uix.VBox( ...
                'Parent', converterBox);
            seperator = javacomponent(javax.swing.JSeparator(), [], converterBoxLayout);
            seperator.setForeground(java.awt.Color(186/255, 201/255, 219/255));
            converterLayout= uix.HBox( ...
                'Parent', converterBoxLayout, ...
                'Padding', 11);
            ...
            set(converterBoxLayout, 'Heights', [1 -1]);
